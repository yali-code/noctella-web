...
export function toProposalReview(row: AiIntakeProposalRecord, stale: boolean): AiIntakeProposalReview {
  ...
  return {
    ...
    suggestedCategoryId: (row.suggestedCategoryId as string | null) ?? undefined,
    suggestedBrand: (row.suggestedBrand as string | null) ?? undefined,
    suggestedModel: (row.suggestedModel as string | null) ?? undefined,
    suggestedManufacturer: (row.suggestedManufacturer as string | null) ?? undefined,
    suggestedCountryOfOrigin: (row.suggestedCountryOfOrigin as string | null) ?? undefined,
    suggestedPeriod: (row.suggestedPeriod as string | null) ?? undefined,
    suggestedMaterials: (row.suggestedMaterials as string | null) ?? undefined,
    suggestedCondition: (row.suggestedCondition as string | null) ?? undefined,
    suggestedConditionDescription: (row.suggestedConditionDescription as string | null) ?? undefined,
    suggestedSeoTitle: (row.suggestedSeoTitle as string | null) ?? undefined,
    suggestedMetaDescription: (row.suggestedMetaDescription as string | null) ?? undefined,
    suggestedPriceEur: toOptionalNumber(row.suggestedPriceEur),
