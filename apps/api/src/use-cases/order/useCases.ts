...
import { BadRequestError, CheckoutPriceChangedError, ConflictError, NotFoundError } from "../../services/errors";
...
export function finalizeInternalOrderInTransaction(
  ...
  if (codPending && toEurCents(input.subtotalAmount) !== subtotalCents) throw new CheckoutPriceChangedError();
