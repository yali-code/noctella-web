...
import { auditInventoryRepositorySource, inventoryRepositoryAuditFixtures, inventoryRepositoryImplementationFiles, runInventoryRepositoryAudit } from "../src/scripts/inventoryRepositoryAudit";
describe("Sprint 31A I1 inventory repository audit",()=>{
 ...
 test("discovers every inventory implementation including the stock-sync writer",()=>expect(inventoryRepositoryImplementationFiles()).toContain("stockSyncIntentWriter.ts"));
 const cases=[
