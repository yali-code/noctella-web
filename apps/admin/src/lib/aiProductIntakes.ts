...
/**
 * Sprint 106: the Stock Acceptance request contract - deliberately no `sku`
 * field (now system-generated by the backend). Every AI Full Product
 * Analysis field is admin-reviewable/editable before submission.
 */
...
export const aiProductIntakesApi = {
  ...
  acceptIntoStock: (id: string, input: StockAcceptanceInput) => api.post<Product>(`/api/ai-product-intakes/${id}/stock-acceptance`, input),
