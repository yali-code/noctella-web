...
export const mapShipmentReady=(q:any)=>({ orderId:q.orderId, orderNumber:q.orderNumber, packingTaskId:q.packingTaskId, shipmentId:q.shipmentId, customerMaskedSummary:maskCustomer(q.customerMaskedSummary), packingStatus:q.packingStatus, packageCount:Number(q.packageCount??0), totalWeight:q.totalWeight, readinessIssues:q.readinessIssues??[] });
